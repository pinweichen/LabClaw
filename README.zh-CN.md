...
<details>
<summary><strong>👁️ Vision & XR（视觉与XR） — 5 个技能</strong></summary>

> 面向手部追踪、3D姿态估计、手物分割与Egocentric视觉的工具。优化用于XR/AR应用、智能眼镜界面与计算机视觉研究。

**5 个技能** &nbsp;·&nbsp; [`skills/vision/`](skills/vision/)

#### 手部检测与追踪

| 技能 | 说明 |
|-------|-------------|
| [`handtracking`](skills/vision/handtracking/SKILL.md) | 实时Egocentric视频手部检测（victordibia/handtracking）。输出手部边界框，专门在EgoHands数据集上训练。轻量级快速，适用于第一人称视角应用。 |
| [`hands-3d-pose`](skills/vision/hands-3d-pose/SKILL.md) | 高质量Egocentric视频3D手部姿态估计（ECCV 2024）。提供3D关节关键点和骨骼可视化投影到2D。针对日常Egocentric活动优化，精度领先。 |

#### 分割与分析

| 技能 | 说明 |
|-------|-------------|
| [`egohos-segmentation`](skills/vision/egohos-segmentation/SKILL.md) | Egocentric手物分割（EgoHOS）- Egocentric视频中的手和物体像素级分割。专门针对手物交互场景，提供像素级精确掩码。 |

#### 多视角3D追踪

| 技能 | 说明 |
|-------|-------------|
| [`hot3d`](skills/vision/hot3d/SKILL.md) | Meta Facebook HOT3D数据集 - Aria/Quest智能眼镜的多视角Egocentric手物3D追踪。最先进的多视角3D手部姿态、物体姿态和手物交互追踪，毫米级精度。 |
| [`hand-tracking-toolkit`](skills/vision/hand-tracking-toolkit/SKILL.md) | Facebook Research手部追踪评估与可视化工具集。支持加载HOT3D数据、计算指标（PA-MPJPE、AUC）、可视化3D姿态投影和生成追踪评估报告。 |
